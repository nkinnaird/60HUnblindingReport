\graphicspath{ {Figures/Pileup/} {Figures/Main/} {Figures/ResidualsFFT/} {Figures/FitStartScans/} }
...
\centering
  ...
  %   \end{subfigure}
    ...
    \begin{subfigure}[]{0.45\textwidth}
	    \centering
		\includegraphics[width=\textwidth]{RatioCBO_\#phi_FS_Canv}
	    \caption{}
    \end{subfigure}% %you need this % here to add spacing between subfigures
    \vspace{4mm}
    \begin{subfigure}[]{0.45\textwidth}
	    \centering
		\includegraphics[width=\textwidth]{RatioCBO_A_Vs_FS_Canv}
	    \caption{}
    \end{subfigure}
    \begin{subfigure}[]{0.45\textwidth}
	    \centering
		\includegraphics[width=\textwidth]{RatioCBO_#omega_\{cbo\}_Vs_FS_Canv}
	    \caption{}
    \end{subfigure}% %you need this % here to add spacing between subfigures
    \vspace{4mm}
    \begin{subfigure}[]{0.45\textwidth}
	    \centering
		\includegraphics[width=\textwidth]{RatioCBO_N_\{cbo-A\}_FS_Canv}
	    \caption{}
    \end{subfigure}
    \begin{subfigure}[]{0.45\textwidth}
	    \centering
		\includegraphics[width=\textwidth]{RatioCBO_N_\{cbo-#phi\}_FS_Canv}
	    \caption{}
    \end{subfigure}% %you need this % here to add spacing between subfigures
\caption[FitStartScans]{}
