...
\section{7 Parameter Ratio Fit}
	...
	\begin{tabular*}{.8\linewidth}{@{\extracolsep{\fill}}|l|l|c|c|}
	  ...
	  \hline
	\end{tabular*}
	\caption{Table of final fit parameters.}
	\end{table}
