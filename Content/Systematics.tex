\graphicspath{ {Figures/Pileup/Multiplier/} {Figures/Pileup/Phase/} {Figures/Pileup/EnergyScaling/} {Figures/RandomSeeds/FitStartScans/} {Figures/RandomSeeds/FitIterations/} {Figures/Miscellaneous/} {Figures/FitStartScans/} {Figures/CBO/FixedFrequency/} {Figures/CBO/Shape/} {Figures/CBO/LifetimeScan/} {Figures/Gain/InFill/} {Figures/VW/} }
...
\section{Sensitivity of \texorpdfstring{$\omega_{a}$}{} to CBO function}
	...
	Talk about the model used and how it works, include picture of CBO frequency from one of James' slides, then try some fits with some other frequency parameters changed and see what difference that makes in the fit.
