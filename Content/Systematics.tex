...
\label{Sec:SystematicGain}
	...
	\subsection{In-Fill Gain}
		...
		The in-fill gain sag function was determined by Matthias Smith and the laser team as described in \DB{14077}, \cite{IFG}. The function goes as  
			\begin{gather}
