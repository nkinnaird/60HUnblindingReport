...
\newcolumntype{B}{>{\boldmath\textbf}D{.}{.}{2,4}} % define a column type L with specific spacing before and after the decimal point
% \newcolumntype{B}{>{\boldmath\DC@{.}{.}{2,4}}l<{\DC@end}}
